...
void main() {
  ...
  group("get current weather", () {
    test("should return weather model when the response code is 200", () async {
      ...
      //act
      final result = await weatherRemoteDataSourceImpl.getCurrentWeather(cityName: testCityName);
    ...
    test(
      ...
      () async {
        ...
        //act
        final result = weatherRemoteDataSourceImpl.getCurrentWeather(cityName: testCityName);
